      ...
      child: Scaffold(
        ...
        onPressed: () {
          if (_searchController.text.isNotEmpty) {
            ...
            FirebaseFirestore.instance.collection('Users').doc(widget.id).collection('home').add({
        ...
        label: Text('Save Home',style: TextStyle(color: Colors.black)),
